...
class FileParser:
    """
    A utility class to parse different document types.
    All methods are static as they don't rely on instance state.
    """
    ...
    def parse_document(uploaded_file):
        ...
        if file_extension == 'pdf':
            content = FileParser.parse_pdf(file_bytes)
        elif file_extension == 'docx':
            content = FileParser.parse_docx(file_bytes)
        else:
